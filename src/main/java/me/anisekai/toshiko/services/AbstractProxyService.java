 ...
 */
public abstract class AbstractProxyService<E extends I, ID extends Serializable, I extends IEntity<ID>, R extends JpaRepository<E, ID>> {
    ...
    private final class ProxyBulk {
        ...
        private ProxyBulk(Function<R, List<E>> selector) {
            ...
            List<E> data = selector.apply(AbstractProxyService.this.repository);
        ...
        public List<E> commit() {
            ...
            AbstractProxyService.this.repository.saveAll(this.entities);
            List<E> refreshed = this.selector.apply(AbstractProxyService.this.repository);
            ...
            refreshed.stream()
                     ...
                     .forEach(AbstractProxyService.this.publisher::publishEvent);
    ...
    public AbstractProxyService(ApplicationEventPublisher publisher, R repository, Supplier<E> initializer) {
