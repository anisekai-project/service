 ...
 */
public class AbstractDataService<E extends I, ID extends Serializable, I extends IEntity<ID>, R extends JpaRepository<E, ID>, P extends AbstractProxyService<E, ID, I, R>> {

    private final P proxy;

    public AbstractDataService(P proxy) {
