...
public final class Texts {
    ...
    public static final String ANIME_UPDATE__DESCRIPTION   = "Mettre à jour un anime";
    public static final String ANIME_UPDATE__OPTION_ANIME  = "Nom de l'anime";
    public static final String ANIME_UPDATE__OPTION_STATUS = "Nouveau statut de l'anime";

    public static final String ANIME_REMOVE__DESCRIPTION  = "Supprime un anime de la liste";
    public static final String ANIME_REMOVE__OPTION_ANIME = "Nom de l'anime";
