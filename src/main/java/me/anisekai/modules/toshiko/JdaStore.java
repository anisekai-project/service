...
import me.anisekai.modules.shizue.exceptions.JdaUnavailableException;
...
public class JdaStore extends ListenerAdapter {
    ...
    private final ToshikoConfiguration configuration;

    private JDA jda;

    public JdaStore(ToshikoConfiguration configuration) {
