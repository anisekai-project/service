...
@Component
public class AnnouncementUpdateTaskFactory implements TaskFactory<AnnouncementUpdateTaskExecutor> {

    public static final String           NAME = "announcement:update";
    private final       TaskingService   service;
    private final       JdaStore         store;
    private final       AnimeDataService animeService;

    public AnnouncementUpdateTaskFactory(TaskingService service, JdaStore store, AnimeDataService animeService) {
    ...
    @Override
    public Class<AnnouncementUpdateTaskExecutor> getTaskClass() {

        return AnnouncementUpdateTaskExecutor.class;
    }
     ...
     */
    @Override
    public AnnouncementUpdateTaskExecutor create() {

        return new AnnouncementUpdateTaskExecutor(this.animeService, this.store);
    }
