...
public enum AnimeStatus {
    ...
    WATCHED("✅", "Visionné"),
    WATCHING("👀", "En cours de visionnage", false, true),
    SIMULCAST("\uD83D\uDD58", "Visionnage en simulcast", false, true),
    ...
    AnimeStatus(String icon, String label, boolean watchable) {
        ...
        this(icon, label, watchable, false);
    }

    AnimeStatus(String icon, String label, boolean watchable, boolean showProgress) {
