...
public class EventSchedulerTests {
    ...
    private static class Manager implements SchedulerManager<TestWatchTarget, TestWatchParty, TestWatchParty> {
        ...
        @Override
        public TestWatchParty create(Plannifiable<TestWatchTarget> plannifiable) {

            return new TestWatchParty(
                    this.id(),
                    plannifiable.getWatchTarget(),
                    plannifiable.getFirstEpisode(),
                    plannifiable.getStartingAt(),
                    plannifiable.getEpisodeCount(),
                    plannifiable.isSkipEnabled()
            );
        }
        ...
        @Override
        public List<TestWatchParty> update(List<TestWatchParty> entities, Consumer<TestWatchParty> updateHook) {
    ...
    public void testSingleSchedulingNoConflict() {
        ...
        TestSpot      spot       = new TestSpot(this.data.target2, scheduleAt, 1);
        ...
        TestWatchParty party = Assertions.assertDoesNotThrow(
                ...
                "An error as occured while scheduling the event."
        );
    ...
    public void testSingleSchedulingWithConflict() {
        ...
        TestSpot spot = new TestSpot(this.data.target2, TestData.BASE_DATETIME, 1);
    ...
    public void testSingleSchedulingFollowUp() {
        ...
        ZonedDateTime scheduleAt = TestData.BASE_DATETIME.plusDays(1);
        TestSpot      spot       = new TestSpot(this.data.target1, scheduleAt, 1);
    ...
    public void testDelayingSuccess() {
        ...
        Assertions.assertEquals(this.data.partyA1, parties.get(0), "Wrong item delayed");
    ...
    @Test
    @DisplayName("Scheduling | Calibration - After Scheduling")
    public void testCalibrationAfterScheduling() {
        ...
        Assertions.assertEquals(2, res.getUpdateCount(), "Unexpected count of updates");
        Assertions.assertEquals(0, res.getDeleteCount(), "Unexpected count of deletes");
    ...
    public void testCalibrationUpstreamDeleteOnly() {
        ...
        Assertions.assertEquals(0, res.getUpdateCount(), "Unexpected count of updates");
        Assertions.assertEquals(3, res.getDeleteCount(), "Unexpected count of deletes");
    ...
    public void testCalibrationUpstreamUpdateDelete() {
        ...
        Assertions.assertEquals(2, res.getDeleteCount(), "Unexpected count of deletes");
